...
def main():
    ...
    while True:
        ...
        print("7. What lists need to be completed? (show lists)")
        print("8. I am busy now see you later. (Exit)")
        ...
        if choice == '1':
            ...
            print("What tasks are you going to accomplish today.\n", my_dog.get_image(1))
        elif choice == '3':
